...
<body>
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Vehicle Solution</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
 ...
 @yield('body')
                ...
                <div id="footer" style="color:red;" align="right">
                    <div class="copyright" >
                        <a href="" >2015 © Akash Technology</a></div>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
